package com.example.somina.weather_app;
...
import com.example.somina.weather_app.network.CallAdder;
import com.example.somina.weather_app.network.NetworkStatus;
import com.example.somina.weather_app.network.OnWebServiceResult;
...
public class MainActivity extends AppCompatActivity implements OnWebServiceResult {
    ...
    private void getTempInfo() {
        ...
        if (NetworkStatus.getInstance(this).isConnectedToInternet()) {
            CallAdder call = new CallAdder(this, url, parameters, CommonUtilities.SERVICE_TYPE.GET_DATA, this);
            call.execute();
        } else {
