...
public class CallAdder extends AsyncTask<String, Void, String> {
    ...
    public CallAdder(Context context, String url, FormEncodingBuilder formBody, CommonUtilities.SERVICE_TYPE Servicetype, OnWebServiceResult resultListener) {
